...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_zzbcq3p', 'template_yxw9ko6', form.current, 'jriF0iqA0RFxBgbYQ')
        .then((result) => {
        ...
        <div className="contact container section" id="contact">
            ...
            <div className="contact_container grid">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact_form">
                    ...
                    <button className="btn" type='submit' value="Send" data-aos="zoom-out-up" data-aos-duration="1000">Send Message</button>
                </form>
            </div>
        </div>
    )
